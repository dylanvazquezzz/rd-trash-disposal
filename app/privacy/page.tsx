    ...
    <>
      ...
      <main className="min-h-screen bg-white pt-24 pb-20 px-4">
        <div className="max-w-2xl mx-auto">
          <h1 className="font-display text-4xl text-[#010c1c] mb-8">Privacy Policy</h1>

          <div className="prose prose-gray max-w-none space-y-6 text-gray-600 leading-relaxed">
            <p className="text-sm text-gray-400">Last updated: April 2026</p>

            <section>
              <h2 className="font-display text-2xl text-[#010c1c] mb-3">What We Collect</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#010c1c] mb-3">How We Use It</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#010c1c] mb-3">Data Storage</h2>
              <p>
            ...
            <section>
              <h2 className="font-display text-2xl text-[#010c1c] mb-3">Contact</h2>
              <p>

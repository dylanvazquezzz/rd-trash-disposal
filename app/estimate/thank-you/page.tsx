    ...
    <>
      ...
      <main className="min-h-screen bg-[#F8F6F1] flex items-center justify-center px-4 pt-20">
        <div className="max-w-md w-full text-center">
          <div className="w-20 h-20 bg-[#010c1c] rounded-full flex items-center justify-center mx-auto mb-6">
            <svg className="w-10 h-10 text-[#F5A623]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
            </svg>
          </div>
          <h1 className="font-display text-3xl font-bold text-[#010c1c] mb-3">
            Request Received
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-8">
            <PhoneLink source="thank_you" className="inline-block bg-[#010c1c] text-white font-semibold px-6 py-3 rounded hover:bg-[#0a1e3a] transition-all" />
          </div>
          <a
            href="/"
            className="inline-block text-gray-500 underline text-sm hover:text-[#010c1c] transition-colors"
          >
            Back to Home
          </a>
        </div>

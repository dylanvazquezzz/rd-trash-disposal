...
export default function CommercialJunkRemovalPage() {
  return (
    <>
      ...
      <main>
        {/* Hero */}
        <section className="bg-[#0B1E3D] pt-32 pb-24 px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 text-center">
              {[
                ...
                <p key={item} className="font-display text-[#0B1E3D] text-lg tracking-wide">
                  {item.toUpperCase()}
                </p>
              ))}
            </div>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-14">
              ...
              <h2 className="font-display text-[#0B1E3D] text-5xl sm:text-6xl mb-4">WHO WE WORK WITH.</h2>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="bg-[#F5F7FA] rounded-2xl p-6 border border-gray-100">
                  <h3 className="font-display text-[#0B1E3D] text-2xl mb-2">{item.title.toUpperCase()}</h3>
        ...
        <section className="py-20 bg-[#F5F7FA]">
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            <div className="text-center mb-14">
              ...
              <h2 className="font-display text-[#0B1E3D] text-5xl sm:text-6xl">ANY COMMERCIAL LOAD.</h2>
            </div>
              ...
              {services.map((s) => (
                <div key={s.title} className="bg-white rounded-2xl p-6 border border-gray-100">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <h3 className="font-display text-[#0B1E3D] text-xl mb-1">{s.title.toUpperCase()}</h3>
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="font-display text-[#0B1E3D] text-5xl mb-6">THE COMMERCIAL DIFFERENCE.</h2>
                <div className="space-y-5">
                  {[
                    ...
                    <div key={item.heading} className="flex gap-4">
                      ...
                      <div>
                        <p className="font-semibold text-[#0B1E3D] mb-1">{item.heading}</p>
              ...
              <div className="bg-[#0B1E3D] rounded-2xl p-8 text-center">
                ...
                <a
                  href="/commercial/estimate"
                  className="block w-full bg-[#F5A623] text-[#0B1E3D] font-bold px-6 py-4 rounded-lg hover:bg-amber-400 transition-all hover:scale-105 mb-4"
                >
                  Request Commercial Quote
                </a>
                <PhoneLink
                  ...
                  className="block w-full border-2 border-white text-white font-semibold px-6 py-4 rounded-lg hover:bg-white hover:text-[#0B1E3D] transition-all"
                />
              </div>
            </div>
          </div>
        ...
        <section className="py-20 bg-[#F5F7FA]">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
            ...
            <h2 className="font-display text-[#0B1E3D] text-5xl mb-4">WHERE WE WORK.</h2>
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              {cities.map((city) => (
                <a
                  ...
                  className="bg-white border border-gray-200 text-[#0B1E3D] font-semibold px-5 py-3 rounded-xl hover:border-[#F5A623] hover:bg-[#FFFBF2] transition-all text-sm"
                >
                  {city.name}
                </a>
              ))}
        ...
        <section className="py-16 bg-[#0B1E3D]">
          <div className="max-w-2xl mx-auto px-4 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                href="/commercial/estimate"
                className="inline-flex items-center justify-center border-2 border-white text-white font-semibold px-8 py-4 rounded-lg hover:bg-white hover:text-[#0B1E3D] transition-all"
              >
                Request Commercial Quote
              </a>
            </div>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <h2 className="font-display text-[#010c1c] text-5xl sm:text-6xl leading-none mb-6">
            ...
            <div className="flex flex-wrap gap-2 mb-8">
              {areas.map((area) => (
                <a
                  ...
                  className="bg-white border border-gray-200 text-[#010c1c] text-sm font-medium px-3 py-1.5 rounded-full shadow-sm hover:border-[#F5A623] hover:text-[#F5A623] transition-colors"
                >
                  {area.name}
                </a>
              ))}
              <span className="bg-[#F5A623] text-[#010c1c] text-sm font-bold px-3 py-1.5 rounded-full">
                + More
              </span>
            </div>

            <div className="flex flex-col sm:flex-row gap-3">
              <PhoneLink source="service_areas" className="inline-flex items-center justify-center gap-2 bg-[#010c1c] text-white font-semibold px-6 py-3 rounded-lg hover:bg-[#0a1e3a] transition-all hover:scale-105">
          ...
          <div className="relative">
            <div className="relative rounded-2xl overflow-hidden shadow-xl border-4 border-white">
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-t from-[#010c1c]/60 to-transparent" />
            ...
            {/* Floating badge */}
            <div className="absolute -top-4 -right-4 bg-[#F5A623] text-[#010c1c] rounded-2xl p-4 shadow-xl">
